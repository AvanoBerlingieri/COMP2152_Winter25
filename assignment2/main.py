   ...
   &   (  @    (   / /   *    @  .   /  
    ...
    while num_dream_lvls < 0 or num_dream_lvls > 3:
        try:
            ...
            if num_dream_lvls == "":
                raise ValueError("Input cannot be empty. Please enter a number between 0 and 3.")

            num_dream_lvls = int(num_dream_lvls)
            if num_dream_lvls < 0 or num_dream_lvls > 3:
                raise ValueError("Number entered must be a whole number between 0-3, try again.")
