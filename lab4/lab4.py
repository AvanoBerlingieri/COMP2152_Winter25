...
# 5.
if loot_options:
    input("You found a loot bag! Roll for loot (Press Enter)")
    selected_loot = loot_options.pop(random.randint(0, len(loot_options) - 1))
    belt.append(selected_loot)
    print(f"You obtained: {selected_loot}")
    print(f"Your belt: {belt}")

# 6.
if loot_options:
    input("You found another loot bag! Roll for loot (Press Enter)")
    selected_loot = loot_options.pop(random.randint(0, len(loot_options) - 1))
    belt.append(selected_loot)
    print(f"You obtained: {selected_loot}")
    print(f"Your belt: {belt}")
...
print(f"Monster rolled: {rolled_power}")

# 3.
m_combat_strength = min(6, m_combat_strength + monster_powers[rolled_power])
print(f"Monster's combat strength updated to {m_combat_strength}")
